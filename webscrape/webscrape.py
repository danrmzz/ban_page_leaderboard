...
async def run_scraper():
    async with async_playwright() as p:
        ...
        tasks = [process_page(page_number, browser) for page_number in range(1, 123)]
...
def main():
    ...
    # Output the top 10 leaderboard to a JSON file
    with open('top10.json', 'w') as f:
        json.dump(top_10_with_uuids, f, indent=4)
